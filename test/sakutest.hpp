...
#define OBSTACLE_PLATFORM_CONFIG_FILE	"./resources/config/obstacle_platform.config"
...
struct __yums {FrameRangeAnimator *u, *r, *d, *l;};
struct __yams {FrameRangeAnimation *u, *r, *d, *l;};
